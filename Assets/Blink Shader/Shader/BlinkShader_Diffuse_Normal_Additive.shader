...
/*SF_DATA;ver:0.17;sub:START;pass:START;ps:lgpr:1,nrmq:1,limd:1,blpr:2,bsrc:0,bdst:0,culm:0,dpts:2,wrdp:False,uamb:True,mssp:True,ufog:True,aust:True,igpj:True,qofs:0,lico:1,qpre:3,flbk:,rntp:2,lmpd:False,lprd:False,enco:False,frtr:True,vitr:True,dbil:False,rmgx:True,hqsc:True,hqlp:False,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300;n:type:ShaderForge.SFN_Final,id:1,x:32510,y:32857|diff-4-OUT,normal-20-RGB,emission-33-OUT,alpha-3-A;n:type:ShaderForge.SFN_Tex2d,id:2,x:33361,y:32227,ptlb:Diffuse,tex:b66bceaf0cc0ace4e9bdc92f14bba709,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Color,id:3,x:33361,y:32419,ptlb:MainColor,c1:0.5,c2:0.5,c3:0.5,c4:1;n:type:ShaderForge.SFN_Multiply,id:4,x:33164,y:32329|A-2-RGB,B-3-RGB;n:type:ShaderForge.SFN_Tex2d,id:11,x:33505,y:32797,ptlb:Emission,tex:e6e7abfd01541984db62a8d677d6b2d7,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Color,id:12,x:33505,y:33001,ptlb:Emission Color,c1:0.4779412,c2:0.4779412,c3:0.4779412,c4:1;n:type:ShaderForge.SFN_Multiply,id:13,x:33281,y:32879|A-11-RGB,B-12-RGB;n:type:ShaderForge.SFN_Tex2d,id:20,x:33361,y:32618,ptlb:Normal,tex:bbab0a6f7bae9cf42bf057d8ee2755f6,ntxv:3,isnm:True;n:type:ShaderForge.SFN_Time,id:28,x:33560,y:33276;n:type:ShaderForge.SFN_Sin,id:29,x:33217,y:33338|IN-30-OUT;n:type:ShaderForge.SFN_Multiply,id:30,x:33380,y:33338|A-28-T,B-31-OUT;n:type:ShaderForge.SFN_ValueProperty,id:31,x:33560,y:33464,ptlb:Speed Blink,v1:10;n:type:ShaderForge.SFN_Abs,id:32,x:33061,y:33338|IN-29-OUT;n:type:ShaderForge.SFN_Multiply,id:33,x:32859,y:33151|A-43-OUT,B-32-OUT;n:type:ShaderForge.SFN_ValueProperty,id:42,x:33281,y:33102,ptlb:Emission Power,v1:1;n:type:ShaderForge.SFN_Multiply,id:43,x:33062,y:33003|A-13-OUT,B-42-OUT;proporder:2-3-20-11-12-42-31;pass:END;sub:END;*/

Shader "Langvv/BlinkShader_Diffuse_Normal_Additive" {
    Properties {
...
////// Emissive:
                ...
                float4 node_3 = _MainColor;
                float3 finalColor = diffuse * (tex2D(_Diffuse,TRANSFORM_TEX(node_52.rg, _Diffuse)).rgb*node_3.rgb) + emissive;
/// Final Color:
...
/////// Diffuse:
                ...
                float4 node_3 = _MainColor;
                float3 finalColor = diffuse * (tex2D(_Diffuse,TRANSFORM_TEX(node_53.rg, _Diffuse)).rgb*node_3.rgb);
/// Final Color:
