...
namespace Adobe.Substance.Runtime
{
    ...
    public class SubstanceRuntimeGraph : MonoBehaviour
    {
        ...
        /// </summary>
        public Material DefaulMaterial => GraphSO.Graph.OutputMaterial;
        ...
        /// </summary>
        /// <returns></returns>
        private readonly Dictionary<string, ISubstanceInput> _inputsTable = new Dictionary<string, ISubstanceInput>();
        ...
        private void InitializeGraph(SubstanceGraph graph)
        {
            ...
            {
                _inputsTable.Add(input.Description.Identifier, input);
        ...
        protected void Update()
        {
            while (_asyncRenderQueue.TryDequeue(out AsyncRenderResult result))
            {
                ...
                GraphSO.Graph.UpdateOutputTextures(result.RenderResult);
        ...
        {
            if (!TryGetInput(inputName, out ISubstanceInput input))
        ...
        private bool TryGetInput(string name, out Input.ISubstanceInput input)
        {
        ...
        /// </summary>
        /// <param name="graphID">Target graph.</param>
        ...
        public void Render()
        {
            var result = _runtimeHandler.Render(GraphSO.Graph.Index);
            GraphSO.Graph.UpdateOutputTextures(result);
        }
        ...
        {
            _runtimeHandler.ApplyPreset(GraphSO.Graph.Index, presetXML);
        }
        ...
        {
            return _runtimeHandler.CreatePresetFromCurrentState(GraphSO.Graph.Index);
        }
