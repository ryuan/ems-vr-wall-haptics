...
public class SinglePulse
{
    ...
    public static byte[] getCommand(int channel_number, int pulse_width, int pulse_current)
    {
        ...
        {
            Debug.Log("SAFETY LIMIT (of " + RehaStimInterface.maxPulseCurrent + " EXCEEDED. Request of " + pulse_current + "dropped to limit");
            pulse_current = RehaStimInterface.maxPulseCurrent;
        }
        if (pulse_width > RehaStimInterface.maxPulseWidth)
        {
            Debug.Log("SAFETY LIMIT (of " + RehaStimInterface.maxPulseWidth + " EXCEEDED. Request of " + pulse_width + "dropped to limit");
